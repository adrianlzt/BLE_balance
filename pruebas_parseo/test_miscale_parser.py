...
class TestMiscale:
    ...
    def test_miscale_v1(self):
       ...
       #data_string = "043e2b020100008995c08c47c81f02010603021d1809ff5701c8478cc095890d161d18a22044b20701010a1a15c5"
        #data_string = "043e1d020100008995c08c47c8110201060d161d18a22044b20701010a1a15c5" # recortado, funciona, datos orig

        # pegado lo que me da mi advertiser() empezando en 020106
        data_string = "043e1d020100008995c08c47c8110201060d161d1820584d0000000000000064"
        ...
        assert sensor_msg["packet"] == "20584d00000000000000"
        assert sensor_msg["data"]
        assert sensor_msg["non-stabilized weight"] == 99.0
        assert sensor_msg["weight unit"] == "kg"
        assert sensor_msg["weight removed"] == 0
        assert sensor_msg["stabilized"] == 1
        assert sensor_msg["rssi"] == 100
